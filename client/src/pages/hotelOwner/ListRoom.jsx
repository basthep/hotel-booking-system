       ...
       <table className="w-full">
        <thead className="bg-gray-50">
            <tr>
                ...
                <th className="py-3 px-4 text-gray-800 font-medium max-sm:hidde">Facility</th>
         ...
         {rooms.map((item,index)=>(
            <tr key={index}>
                ...
                <td className="py-3 px-4 border-t border-gray-300 text-sm text-red-500 text-center">
                 <label className="relative inline-flex items-center cusor-pointer text-gray-900 gap-3">
