...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-16 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
     ...
     <p className="mt-6 text-gray-500 text-xs text-center">By subscribing, you agree to our Privacy Policy and consent to receive updates.</p>
    </div>
  )
}
